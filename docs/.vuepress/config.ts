/**
 * 提示：如您想使用JS版本的配置文件可参考：https://github.com/lhing17/vuepress-theme-vdoing/tree/a2f03e993dd2f2a3afdc57cf72adfc6f1b6b0c32/docs/.vuepress
 */
...
const DOMAIN_NAME = 'gsein.cn' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "吉森的技术小站",
      description: 'web开发技术博客,专注web前后端技术学习与总结。',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'lhing17/vuepress-theme-vdoing', // 导航栏右侧生成Github链接
    ...
    author: {
      name: '吉森', // 必需
      link: 'https://github.com/lhing17', // 可选的
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/playlist?id=7389946816&userid=3275621054',
        },
      ],
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: 'web技术博客,个人技术博客,前端,前端开发,后端,后端开发,前端框架,后端框架,web前端,web后端,技术文档,学习,Java,Spring,JavaScript,js,ES6,TypeScript,vue,python,css3,html5,Node,git,github,markdown',
      },
    ],
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: 'cba20fe176357066a366',
          clientSecret: '0526c9eeaf85d1b2dc67bb32400a1250520b4659',
          repo: 'blog-gitalk-comment', // GitHub 仓库
          owner: 'lhing17', // GitHub仓库所有者
          admin: ['lhing17'], // 对仓库有写权限的人
